...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.9227 |
| Learning Progress (mean |error| over 100 ticks) | 0.5897 |
| Mushroom Weight Changes (assoc_count) | 1338 |
| Reward Trend (cumulative) | 5.8959 |
| Error Gradient Mean | 0.5897 |
| Gain Update Count | 5135 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-15 01:01:57 UTC*
