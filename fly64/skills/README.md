...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 0.5011 |
| Learning Progress (mean |error| over 100 ticks) | 0.8571 |
| Mushroom Weight Changes (assoc_count) | 16279 |
| Reward Trend (cumulative) | -44.5742 |
| Error Gradient Mean | 0.8571 |
| Gain Update Count | 31989 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-16 17:40:57 UTC*
