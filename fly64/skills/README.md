...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 0.5004 |
| Learning Progress (mean |error| over 100 ticks) | 0.4 |
| Mushroom Weight Changes (assoc_count) | 84506 |
| Reward Trend (cumulative) | -49.9328 |
| Error Gradient Mean | 0.4 |
| Gain Update Count | 104954 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-16 16:28:13 UTC*
