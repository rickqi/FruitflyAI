...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 2.0595 |
| Learning Progress (mean |error| over 100 ticks) | 0.5991 |
| Mushroom Weight Changes (assoc_count) | 1842 |
| Reward Trend (cumulative) | 9.9645 |
| Error Gradient Mean | 0.5991 |
| Gain Update Count | 3496 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-15 00:31:24 UTC*
