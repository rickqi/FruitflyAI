...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.0311 |
| Learning Progress (mean |error| over 100 ticks) | 0.1626 |
| Mushroom Weight Changes (assoc_count) | 570 |
| Reward Trend (cumulative) | -49.8684 |
| Error Gradient Mean | 0.1626 |
| Gain Update Count | 591 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-16 17:04:28 UTC*
