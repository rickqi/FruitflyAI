...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 0.628 |
| Learning Progress (mean |error| over 100 ticks) | 0.4075 |
| Mushroom Weight Changes (assoc_count) | 0 |
| Reward Trend (cumulative) | -2.3726 |
| Error Gradient Mean | 0.4075 |
| Gain Update Count | 95446 |
...
*Auto-generated by EvolutionSkill v3.0.0 on 2026-09-15 14:44:54 UTC*
