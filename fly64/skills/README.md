...
The following 7 patterns are loaded from `default_patterns.json` and validated against JSON Schema (draft-07).
...
*Auto-generated by EvolutionSkill v2.0.0 on 2026-09-13 06:02:01 UTC*
