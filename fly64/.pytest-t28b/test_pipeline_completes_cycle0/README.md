...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.2239 |
| Learning Progress (mean |error| over 100 ticks) | 0.4146 |
| Mushroom Weight Changes (assoc_count) | 263 |
| Reward Trend (cumulative) | -2.1298 |
| Error Gradient Mean | 0.4146 |
| Gain Update Count | 35653 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 10:08:36 UTC*
