...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.2475 |
| Learning Progress (mean |error| over 100 ticks) | 0.9614 |
| Mushroom Weight Changes (assoc_count) | 1265 |
| Reward Trend (cumulative) | -2.135 |
| Error Gradient Mean | 0.9614 |
| Gain Update Count | 73640 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 09:18:28 UTC*
