...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.043 |
| Learning Progress (mean |error| over 100 ticks) | 0.7071 |
| Mushroom Weight Changes (assoc_count) | 816 |
| Reward Trend (cumulative) | -1.2856 |
| Error Gradient Mean | 0.7071 |
| Gain Update Count | 14153 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 08:02:03 UTC*
