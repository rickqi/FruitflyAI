...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 0.8978 |
| Learning Progress (mean |error| over 100 ticks) | 0.982 |
| Mushroom Weight Changes (assoc_count) | 1270 |
| Reward Trend (cumulative) | 6.2281 |
| Error Gradient Mean | 0.982 |
| Gain Update Count | 76622 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 09:20:20 UTC*
