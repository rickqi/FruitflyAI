...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.2157 |
| Learning Progress (mean |error| over 100 ticks) | 0.4263 |
| Mushroom Weight Changes (assoc_count) | 263 |
| Reward Trend (cumulative) | -1.6371 |
| Error Gradient Mean | 0.4263 |
| Gain Update Count | 37084 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 10:10:29 UTC*
