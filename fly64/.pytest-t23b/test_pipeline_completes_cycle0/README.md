...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 0.5005 |
| Learning Progress (mean |error| over 100 ticks) | 0.8571 |
| Mushroom Weight Changes (assoc_count) | 30975 |
| Reward Trend (cumulative) | -46.6278 |
| Error Gradient Mean | 0.8571 |
| Gain Update Count | 48461 |
...
*Auto-generated by EvolutionSkill v3.1.1 on 2026-09-16 17:55:17 UTC*
