...
| Metric | Value |
|--------|-------|
| Dopamine Gain Avg | 1.2685 |
| Learning Progress (mean |error| over 100 ticks) | 0.425 |
| Mushroom Weight Changes (assoc_count) | 263 |
| Reward Trend (cumulative) | -2.3254 |
| Error Gradient Mean | 0.425 |
| Gain Update Count | 28515 |
...
*Auto-generated by EvolutionSkill v3.4.2 on 2026-09-18 09:59:33 UTC*
